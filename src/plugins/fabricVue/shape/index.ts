...
export { default as IText, iTextProps } from './IText';
...
export type { TextboxInst, TextboxProps, FTextboxProps } from './Textbox';
export type { RectInst, RectProps, FRectProps } from './Rect';
