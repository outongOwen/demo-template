import { Fragment, isVNode, type Slot, Comment, type VNodeArrayChildren, type VNodeChild } from 'vue';
 ...
 */
export function resolveSlot(slot: Slot | undefined, fallback: () => VNodeArrayChildren): VNodeArrayChildren {
